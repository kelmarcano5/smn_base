...
--Drop sequences
DROP TABLE smn_base.seq_smn_servicios_componentes;
DROP TABLE smn_base.seq_smn_prestadores_servicios_especialidad;
DROP TABLE smn_base.seq_smn_anexo;
DROP TABLE smn_base.seq_smn_ticket;
DROP TABLE smn_base.seq_smn_tipo_registro;
DROP TABLE smn_base.seq_smn_transaccion_general_modulos;
DROP TABLE smn_base.seq_smn_parentezco;
DROP TABLE smn_base.seq_smn_afiliaciones;
DROP TABLE smn_base.seq_smn_especialidad;
DROP TABLE smn_base.seq_smn_grupos_prestadores;
DROP TABLE smn_base.seq_smn_parroquias;
DROP TABLE smn_base.seq_smn_municipios;
DROP TABLE smn_base.seq_smn_auxiliar_unidades_servicios;
DROP TABLE smn_base.seq_smn_auxiliar_areas_servicios;
DROP TABLE smn_base.seq_smn_auxiliar_tipos_servicios;
DROP TABLE smn_base.seq_smn_estructura_uen;
DROP TABLE smn_base.seq_smn_transaccion_general;
DROP TABLE smn_base.seq_smn_periodos_detalle;
DROP TABLE smn_base.seq_smn_entidades;
DROP TABLE smn_base.seq_smn_sectores_economicos;
DROP TABLE smn_base.seq_smn_comunidades;
DROP TABLE smn_base.seq_smn_paises;
DROP TABLE smn_base.seq_smn_entidades_federales;
DROP TABLE smn_base.seq_smn_ciudades;
DROP TABLE smn_base.seq_smn_corporaciones;
DROP TABLE smn_base.seq_smn_unidades_negocios;
DROP TABLE smn_base.seq_smn_entidades_financieras;
DROP TABLE smn_base.seq_smn_zonas_postales;
DROP TABLE smn_base.seq_smn_tasas_de_cambio;
DROP TABLE smn_base.seq_smn_monedas;
DROP TABLE smn_base.seq_smn_codigos_impuestos;
DROP TABLE smn_base.seq_smn_tasas_impositivas;
DROP TABLE smn_base.seq_smn_periodos;
DROP TABLE smn_base.seq_smn_cuentas_bancarias;
DROP TABLE smn_base.seq_smn_unidades_impositivas;
DROP TABLE smn_base.seq_smn_tipo_cuenta_banco;
DROP TABLE smn_base.seq_smn_menu_traduccion;
DROP TABLE smn_base.seq_smn_servicio_traduccion;
DROP TABLE smn_base.seq_smn_centro_costo;
DROP TABLE smn_base.seq_smn_condicion_pago;
DROP TABLE smn_base.seq_smn_tipo_doc_oficial;
DROP TABLE smn_base.seq_smn_tipo_via;
DROP TABLE smn_base.seq_smn_edificacion;
DROP TABLE smn_base.seq_smn_tipo_localidad;
DROP TABLE smn_base.seq_smn_panel;
DROP TABLE smn_base.seq_smn_feriados;
DROP TABLE smn_base.seq_smn_unidades_servicios;
DROP TABLE smn_base.seq_smn_areas_servicios;
DROP TABLE smn_base.seq_smn_tipos_servicios;
DROP TABLE smn_base.seq_smn_servicios_baremos;
DROP TABLE smn_base.seq_smn_servicios;
DROP TABLE smn_base.seq_smn_baremos_detalle;
DROP TABLE smn_base.seq_smn_baremos;
DROP TABLE smn_base.seq_smn_componentes;
DROP TABLE smn_base.seq_smn_configuracion;
DROP TABLE smn_base.seq_smn_almacen;
DROP TABLE smn_base.seq_smn_formas_pago;
DROP TABLE smn_base.seq_smn_respuestas;
DROP TABLE smn_base.seq_smn_mensajes_contactos;
DROP TABLE smn_base.seq_smn_mensajes;
DROP TABLE smn_base.seq_smn_contactos;
DROP TABLE smn_base.seq_smn_modelos_contratos;
DROP TABLE smn_base.seq_smn_prestadores_servicios_agenda;
DROP TABLE smn_base.seq_smn_agenda;
DROP TABLE smn_base.seq_smn_prestadores_servicios;
DROP TABLE smn_base.seq_smn_auxiliar_sucursales;
DROP TABLE smn_base.seq_smn_auxiliar_unidades_negocios;
DROP TABLE smn_base.seq_smn_auxiliar_centro_costo;
DROP TABLE smn_base.seq_smn_direccion;
DROP TABLE smn_base.seq_smn_auxiliar_corporaciones;
DROP TABLE smn_base.seq_smn_franquicias;
DROP TABLE smn_base.seq_smn_medio_pago;
DROP TABLE smn_base.seq_smn_documentos_generales;
DROP TABLE smn_base.seq_smn_idiomas;
DROP TABLE smn_base.seq_smn_auxiliar_cuenta_bancaria;
DROP TABLE smn_base.seq_smn_auxiliar_contacto;
DROP TABLE smn_base.seq_smn_auxiliar_persona_natural;
DROP TABLE smn_base.seq_smn_auxiliar_tercero;
DROP TABLE smn_base.seq_smn_auxiliar_prestador_servicio;
DROP TABLE smn_base.seq_smn_auxiliar_medico;
DROP TABLE smn_base.seq_smn_auxiliar_contable;
DROP TABLE smn_base.seq_smn_auxiliar_banco;
DROP TABLE smn_base.seq_smn_registros_usuarios;
DROP TABLE smn_base.seq_smn_sucursales;
DROP TABLE smn_base.seq_smn_auxiliar_cond_financiera;
DROP TABLE smn_base.seq_smn_naturaleza_auxiliar;
DROP TABLE smn_base.seq_smn_auxiliar_categoria;
DROP TABLE smn_base.seq_smn_clase_auxiliar;
DROP TABLE smn_base.seq_smn_modulos;
