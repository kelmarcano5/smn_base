...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("trs_auxiliar_unidad_negocio");
			if (d != null)
			{
		...
		d = rs.getString("trs_responsable");
			if (d != null)
			{
			name  = "b_responsible";
		...
		d = rs.getString("trs_auxiliar_unidad_negocio_name");
			if (d != null)
			{
			name  = "b_outsourced_unit_business";
			label = "${lbl:b_outsourced_unit_business}";
