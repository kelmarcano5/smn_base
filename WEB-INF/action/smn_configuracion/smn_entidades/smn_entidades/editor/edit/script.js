...
setComboValue('ent_comunidad','${fld:ent_comunidad}','form1');
setComboValue('ent_corporacion','${fld:ent_corporacion}','form1');
setComboValue('ent_unidad_negocio','${fld:ent_unidad_negocio}','form1');
setComboValue('ent_moneda','${fld:ent_moneda}','form1');
setComboValue('ent_sector_economico','${fld:ent_sector_economico}','form1');
//setComboValue('ent_descripcion_corta','${fld:ent_descripcion_corta}','form1');
//setComboValue('ent_descripcion_larga','${fld:ent_descripcion_larga}','form1');
//setComboValue('ent_descripcion_corta','${fld:ent_descripcion_corta}','form1');

setComboValue('ent_direccion','${fld:ent_direccion}','form1');
...
setComboValue('ent_calcula_redondeo','${fld:ent_calcula_redondeo}','form1');
...
document.form1.smn_tipo_contribuyente_rf.disabled=true;

setComboValue('smn_tipo_contribuyente_rf','${fld:smn_tipo_contribuyente_rf}','form1');
setComboValue('rep_estatus','${fld:rep_estatus}','form1');
