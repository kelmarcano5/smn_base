...
from
	...
	inner join smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = smn_usuarios.smn_auxiliar_rf
	inner join smn_base.smn_clase_auxiliar on smn_base.smn_clase_auxiliar.smn_clase_auxiliar_id = smn_base.smn_usuarios.smn_clase_auxiliar_rf
...
where smn_base.smn_usuarios.smn_usuarios_id is not null
	${filter}
