...
where
	smn_rel_nivel_estruc_atributo_id is not null
	and 	smn_base.smn_nivel_estructura.smn_nivel_estructura_id=smn_base.smn_rel_nivel_estruc_atributo.smn_nivel_estructura_id and
