...
where
	smn_base.smn_auxiliar.smn_auxiliar_id=smn_base.smn_rel_aux_contacto.smn_auxiliar_id and 
	smn_rel_aux_contacto_id is not null
	and 	smn_base.smn_auxiliar.smn_auxiliar_id=smn_base.smn_rel_aux_contacto.smn_auxiliar_id
	${filter}
order by
