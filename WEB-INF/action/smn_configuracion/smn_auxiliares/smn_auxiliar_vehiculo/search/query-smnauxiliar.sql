select
	...
	case
			...
			when smn_base.smn_auxiliar.aux_tipo_persona='VH' then 'Vehiculo'
...
where smn_auxiliar_id is not null and smn_base.smn_clase_auxiliar.cla_codigo='VH' and smn_base.smn_auxiliar.aux_tipo_persona='VH' 
