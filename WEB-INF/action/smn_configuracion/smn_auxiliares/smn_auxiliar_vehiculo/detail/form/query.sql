select
	...
	when smn_base.smn_auxiliar.aux_tipo_persona='GO' then '${lbl:b_government_person}'
			when smn_base.smn_auxiliar.aux_tipo_persona='VA' then '${lbl:b_value}'
	end as aux_tipo_persona,
	smn_base.smn_auxiliar.smn_auxiliar_id,
	smn_base.smn_clase_auxiliar.cla_codigo||'-'||smn_base.smn_clase_auxiliar.cla_nombre as smn_clase_auxiliar_rf_2,
	...
	smn_base.smn_direccion.dir_codigo||'-'||smn_base.smn_direccion.dir_descripcion as aux_direccion_rf,
...
from
	...
	where smn_base.smn_naturaleza_auxiliar.smn_naturaleza_auxiliar_id='3' and
