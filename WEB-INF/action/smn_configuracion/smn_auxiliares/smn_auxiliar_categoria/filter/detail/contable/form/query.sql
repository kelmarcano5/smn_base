...
--	inner join smn_base.smn_auxiliar_contable on smn_base.smn_auxiliar_contable.smn_auxiliar_categoria_id=smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id
--	left outer join smn_base.smn_tipo_doc_oficial on smn_base.smn_tipo_doc_oficial.smn_tipo_doc_oficial_id=smn_base.smn_auxiliar_contable.aac_tipo_doc_oficial 
where
