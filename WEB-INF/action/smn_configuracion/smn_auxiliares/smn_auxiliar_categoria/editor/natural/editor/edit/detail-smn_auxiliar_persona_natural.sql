select
	...
	case
		when smn_base.smn_auxiliar_persona_natural.and_afiliacion='S' then '${lbl:b_yes}'
		when smn_base.smn_auxiliar_persona_natural.and_afiliacion='N' then '${lbl:b_not}'
	end as and_afiliacion2_name,
	(select smn_base.smn_auxiliar_persona_natural.ant_codigo || ' - ' || smn_base.smn_auxiliar_persona_natural.ant_descripcion from  smn_base.smn_auxiliar_persona_natural  where smn_base.smn_auxiliar_persona_natural.smn_auxiliar_persona_natural_id is not null  and smn_base.smn_auxiliar_persona_natural.smn_auxiliar_persona_natural_id=smn_base.smn_auxiliar_persona_natural.and_titular  order by smn_base.smn_auxiliar_persona_natural.ant_descripcion ) as and_titular2_name,
	...
	(select smn_base.smn_auxiliar_cond_financiera.cfn_codigo || ' - ' || smn_base.smn_auxiliar_cond_financiera.cfn_descripcion from  smn_base.smn_auxiliar_cond_financiera  where smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id is not null  and smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id=smn_base.smn_auxiliar_persona_natural.ant_condicion_financiera  order by smn_base.smn_auxiliar_cond_financiera.cfn_descripcion ) as ant_condicion_financiera2_name,
--	(select smn_base.smn_v_auxiliar.aux_codigo || ' - ' || smn_base.smn_v_auxiliar.aux_descripcion from  smn_base.smn_v_auxiliar  where smn_base.smn_v_auxiliar.smn_v_auxiliar_id is not null  and smn_base.smn_v_auxiliar.smn_v_auxiliar_id=smn_base.smn_auxiliar_persona_natural.smn_auxiliar_categoria_id  order by smn_base.smn_v_auxiliar.aux_descripcion ) as smn_auxiliar_categoria_id2_name,
	...
	smn_base.smn_auxiliar_persona_natural.and_afiliacion as and_afiliacion2,
	smn_base.smn_auxiliar_persona_natural.and_titular as and_titular2,
