...
from
	...
	inner join smn_base.smn_auxiliar_prestador_servicio on smn_base.smn_auxiliar_prestador_servicio.smn_auxiliar_categoria_id = smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id
	left outer join smn_base.smn_tipo_doc_oficial on smn_base.smn_tipo_doc_oficial.smn_tipo_doc_oficial_id = smn_base.smn_auxiliar_prestador_servicio.aps_tipo_doc_oficial
	left outer join smn_base.smn_direccion on smn_base.smn_direccion.smn_direccion_id = smn_base.smn_auxiliar_prestador_servicio.aps_direccion
	left outer join smn_base.smn_auxiliar_cuenta_bancaria on smn_base.smn_auxiliar_cuenta_bancaria.smn_auxiliar_cuenta_bancaria_id = smn_base.smn_auxiliar_prestador_servicio.aps_cuenta_bancaria
	left outer join smn_base.smn_auxiliar_contacto on smn_base.smn_auxiliar_contacto.smn_auxiliar_contacto_id = smn_base.smn_auxiliar_prestador_servicio.aps_contactos
	left outer join smn_base.smn_condicion_pago on smn_base.smn_condicion_pago.smn_condicion_pago_id = smn_base.smn_auxiliar_prestador_servicio.aps_cond_pago
where
