...
from
	...
	inner join smn_base.smn_auxiliar_persona_natural on smn_base.smn_auxiliar_persona_natural.smn_auxiliar_categoria_id = smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id
	left outer join smn_base.smn_tipo_doc_oficial on smn_base.smn_tipo_doc_oficial.smn_tipo_doc_oficial_id = smn_base.smn_auxiliar_persona_natural.ant_tipo_doc_oficial
	left outer join smn_base.smn_direccion on smn_base.smn_direccion.smn_direccion_id = smn_base.smn_auxiliar_persona_natural.ant_direccion
	left outer join smn_base.smn_auxiliar_cuenta_bancaria on smn_base.smn_auxiliar_cuenta_bancaria.smn_auxiliar_cuenta_bancaria_id = smn_base.smn_auxiliar_persona_natural.ant_cuenta_bancaria
	left outer join smn_base.smn_auxiliar_contacto on smn_base.smn_auxiliar_contacto.smn_auxiliar_contacto_id = smn_base.smn_auxiliar_persona_natural.ant_contactos
	left outer join smn_base.smn_paises on smn_base.smn_paises.smn_paises_id = smn_base.smn_auxiliar_persona_natural.ant_nacionalidad
	left outer join smn_base.smn_auxiliar_cond_financiera on smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id = smn_base.smn_auxiliar_persona_natural.ant_condicion_financiera
where
