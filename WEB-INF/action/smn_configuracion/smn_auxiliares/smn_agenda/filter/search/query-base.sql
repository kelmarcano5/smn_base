select
	...
	case
		when smn_base.smn_agenda.age_dia_semana='MON' then '${lbl:b_monday_en}'
		when smn_base.smn_agenda.age_dia_semana='TUE' then '${lbl:b_tuesday_en}'
		when smn_base.smn_agenda.age_dia_semana='WED' then '${lbl:b_wednesday_en}'
		when smn_base.smn_agenda.age_dia_semana='THU' then '${lbl:b_thursday_en}'
		when smn_base.smn_agenda.age_dia_semana='FRI' then '${lbl:b_friday_en}'
		when smn_base.smn_agenda.age_dia_semana='SAT' then '${lbl:b_saturday_en}'
		when smn_base.smn_agenda.age_dia_semana='SUN' then '${lbl:b_sunday_en}'
	end as age_dia_semana_en_combo,
	case
