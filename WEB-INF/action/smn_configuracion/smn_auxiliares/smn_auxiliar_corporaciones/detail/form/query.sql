...
from
	smn_base.smn_auxiliar_corporaciones
	inner join smn_base.smn_direccion on smn_base.smn_direccion.smn_direccion_id = smn_base.smn_auxiliar_corporaciones.tcp_direccion
	inner join smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_base.smn_auxiliar_corporaciones.tcp_moneda
	inner join smn_base.smn_auxiliar_unidades_negocios on smn_base.smn_auxiliar_unidades_negocios.smn_auxiliar_unidades_negocios_id = smn_base.smn_auxiliar_corporaciones.tcp_auxiliar_unidad_negocio
