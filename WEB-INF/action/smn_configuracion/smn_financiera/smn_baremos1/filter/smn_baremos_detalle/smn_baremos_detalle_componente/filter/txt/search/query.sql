select
	...
	case
	when smn_base.smn_baremos_detalle_componente.smn_tipo_compuesto_rf='S' then '${lbl:b_services}'
	when smn_base.smn_baremos_detalle_componente.smn_tipo_compuesto_rf='I' then '${lbl:b_item}'
	when smn_base.smn_baremos_detalle_componente.smn_tipo_compuesto_rf='H' then '${lbl:b_honorary}'
