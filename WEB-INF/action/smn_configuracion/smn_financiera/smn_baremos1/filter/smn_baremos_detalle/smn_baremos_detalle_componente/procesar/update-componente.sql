...
smn_base.smn_baremos_detalle.bad_precio_moneda_alterna - SUM(smn_base.smn_baremos_detalle_componente.bdc_monto_ma) as montofinal_alt,
	...
	where smn_base.smn_baremos_detalle_componente.smn_baremos_detalle_id=${fld:id_badet}
...
from qw
WHERE
	smn_base.smn_baremos_detalle_componente.smn_baremos_detalle_id=${fld:id_badet}  and smn_base.smn_baremos_detalle_componente.smn_forma_calculo_rf = 'D';
