$('#detalle_id').val('${fld:smn_baremos_detalle_id}');
$('#formacalculo').val('${fld:smn_forma_calculo_rf}');
var f = '${fld:smn_forma_calculo_rf}';

$('#smn_forma_calculo_rf').val(f.replace(/\s/g, ''));
