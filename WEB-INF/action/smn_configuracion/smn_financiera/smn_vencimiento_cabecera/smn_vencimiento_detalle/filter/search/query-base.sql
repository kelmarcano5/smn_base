...
where
	smn_vencimiento_detalle_id is not null
	and 	smn_base.smn_vencimiento_cabecera.smn_vencimiento_cabecera_id=smn_base.smn_vencimiento_detalle.smn_vencimiento_cabecera_id
	${filter}
order by
