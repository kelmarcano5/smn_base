...
where
	smn_rel_serv_desc_retenc_id is not null
	and 	smn_base.smn_descuentos_retenciones.smn_descuentos_retenciones_id=smn_base.smn_rel_serv_desc_retenc.smn_descuentos_retenciones_id and
