...
from
	...
	inner join smn_base.smn_entidades on smn_base.smn_entidades.smn_entidades_id = smn_base.smn_contrato_base.ctr_empresa_rf
	left outer join smn_base.smn_unidades_servicios on smn_base.smn_unidades_servicios.smn_unidades_servicios_id = smn_base.smn_contrato_base.ctr_unidad_servicio_rf
	left outer join smn_base.smn_transaccion_general on smn_base.smn_transaccion_general.smn_transaccion_general_id = smn_base.smn_contrato_base.ctr_transaccion_rf
	left outer join smn_base.smn_corporaciones on smn_base.smn_corporaciones.smn_corporaciones_id = smn_base.smn_contrato_base.ctr_corporacion_rf
where
