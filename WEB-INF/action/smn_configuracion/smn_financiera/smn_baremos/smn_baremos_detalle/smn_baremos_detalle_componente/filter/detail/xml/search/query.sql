select
	...
	when smn_base.smn_baremos_detalle_componente.smn_tipo_compuesto_rf='HO' then '${lbl:b_honorary}'
		...
		case
	when smn_base.smn_baremos_detalle_componente.smn_forma_calculo_rf='D' then '${lbl:b_diferent}'
	when smn_base.smn_baremos_detalle_componente.smn_forma_calculo_rf='M' then '${lbl:b_mont}'
	when smn_base.smn_baremos_detalle_componente.smn_forma_calculo_rf='P' then '${lbl:b_percentage}'
...
from
	smn_base.smn_baremos_detalle_componente
	left outer join smn_base.smn_baremos_detalle on smn_base.smn_baremos_detalle.smn_baremos_id = smn_base.smn_baremos_detalle_componente.smn_baremos_detalle_id
