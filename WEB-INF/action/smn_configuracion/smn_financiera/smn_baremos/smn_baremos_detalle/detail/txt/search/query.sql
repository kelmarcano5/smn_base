select
	...
	case
	when smn_base.smn_baremos_detalle.bad_tipo_componente='S' then 'Servicios'
	when smn_base.smn_baremos_detalle.bad_tipo_componente='I' then 'Item'
	when smn_base.smn_baremos_detalle.bad_tipo_componente='H' then 'Honorarios'
