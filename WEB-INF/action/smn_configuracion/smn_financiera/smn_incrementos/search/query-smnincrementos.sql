select
	...
	smn_base.smn_incrementos.inc_apli_cant_precio,
	smn_base.smn_incrementos.inc_porcentaje_base,
	smn_base.smn_incrementos.inc_porcentaje_incremento,
	smn_base.smn_incrementos.inc_apli_todos_it,
	smn_base.smn_incrementos.inc_apli_todos_se,
	smn_base.smn_incrementos.inc_apli_todos_af,
	smn_base.smn_incrementos.inc_estatus,
	smn_base.smn_incrementos.inc_monto_ml,
	smn_base.smn_incrementos.inc_monto_ma,
	smn_base.smn_incrementos.inc_fecha_registro
