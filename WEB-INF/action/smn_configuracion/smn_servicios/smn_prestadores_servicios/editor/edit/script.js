var aux = '${fld:prs_auxiliar}';
$('#prs_auxiliar').val(aux).change();

var cla = '${fld:prs_clase_auxiliar}';
$('#prs_clase_auxiliar').val(cla).change();

//$('#prs_auxiliar').val('${fld:prs_auxiliar}').trigger('change');
console.log('${fld:prs_auxiliar}');
//$('#prs_clase_auxiliar').val('${fld:prs_clase_auxiliar}').trigger('change');
