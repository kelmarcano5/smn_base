...
union
select 
	smn_base.smn_rel_grupo_prestador_servicio.smn_rel_grupo_prestador_servicio_id as refid
from 
	smn_base.smn_rel_grupo_prestador_servicio
where 
	smn_base.smn_rel_grupo_prestador_servicio.smn_prestadores_servicios_rf = ${fld:id}
