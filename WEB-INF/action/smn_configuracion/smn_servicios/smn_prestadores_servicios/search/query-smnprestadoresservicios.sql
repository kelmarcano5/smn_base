...
from
	...
	left outer join smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = smn_base.smn_prestadores_servicios.prs_auxiliar
...
ORDER BY smn_base.smn_prestadores_servicios.prs_fecha_registro DESC