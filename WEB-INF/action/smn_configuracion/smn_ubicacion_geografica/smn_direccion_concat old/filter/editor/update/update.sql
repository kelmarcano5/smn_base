UPDATE smn_base.smn_direccion SET
	...
	dir_descripcion=CONCAT(${fld:dir_tipo_localidad_name},',',${fld:dir_tipo_localidad_nom},',',${fld:dir_edificacion_name},',',${fld:dir_edificacion_nom},',',${fld:dir_tipo_via_name},',',${fld:dir_tipo_via_nom},',',${fld:dir_parroquia_name},',',${fld:dir_municipio_name},',',${fld:dir_ciudad_name},',',${fld:dir_entidad_federal_name},',',${fld:dir_pais_name}),
