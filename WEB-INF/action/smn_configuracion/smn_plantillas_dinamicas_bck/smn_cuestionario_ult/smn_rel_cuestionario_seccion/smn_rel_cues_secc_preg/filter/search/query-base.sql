...
from
	...
	inner join smn_base.smn_rel_cuestionario_seccion on smn_base.smn_rel_cuestionario_seccion.smn_rel_cuestionario_seccion_id =  smn_base.smn_rel_cues_secc_preg.smn_rel_cues_secc_preg_id
where
