select	
	...
	(select smn_base.smn_pregunta.prg_tipo_respuesta from  smn_base.smn_pregunta where smn_base.smn_pregunta.smn_pregunta_id is not null  and smn_base.smn_pregunta.smn_pregunta_id=smn_seccion.smn_tipo_respuesta_id) as smn_tipo_respuesta_id_combo,
...
from
	...
	smn_base.smn_respuesta
where
	smn_respuesta.smn_seccion_id=smn_seccion.smn_seccion_id and 
