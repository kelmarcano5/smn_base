select
	...
	smn_respuesta.res_idioma,
	smn_respuesta.res_usuario,
	smn_respuesta.res_fecha_registro,
	smn_respuesta.res_hora,
	smn_respuesta.smn_respuesta_id
...
where
	smn_base.smn_respuesta.smn_respuesta_id is not null
	and 	smn_cuestionario.smn_cuestionario_id=smn_respuesta.smn_cuestionario_id and
