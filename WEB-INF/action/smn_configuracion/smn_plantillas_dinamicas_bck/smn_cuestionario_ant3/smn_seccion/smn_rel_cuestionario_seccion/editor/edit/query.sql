...
where
	...
	smn_seccion.smn_seccion_id=smn_rel_cuestionario_seccion.smn_seccion_id and
	smn_rel_cuestionario_seccion_id = ${fld:id} and
		smn_base.smn_rel_cuestionario_seccion.smn_seccion_id=${fld:id2}
