select
	...
	smn_base.smn_rel_cuestionario_seccion. as _pl0,
...
where
	...
	and 	smn_rel_cuestionario_seccion.smn_rel_cuestionario_seccion_id=smn_rel_cues_secc_preg.smn_rel_cuestionario_seccion_id and
