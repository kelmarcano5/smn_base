UPDATE smn_base.smn_registros_usuarios SET
	...
	rgu_razon_social=${fld:rgu_razon_social},
	rgu_responsable=${fld:rgu_responsable},
	rgu_cargo=${fld:rgu_cargo},
	rgu_num_minist_salud=${fld:rgu_num_minist_salud},
	rgu_num_coleg_medicos=${fld:rgu_num_coleg_medicos},
