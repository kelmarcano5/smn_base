...
document.form1.dir_categoria.value='${fld:dir_categoria@js}';
document.form1.dir_mapa_longitud.value='${fld:dir_mapa_longitud@#,###,##0.00}';
document.form1.dir_mapa_latitud.value='${fld:dir_mapa_latitud@#,###,##0.00}';
