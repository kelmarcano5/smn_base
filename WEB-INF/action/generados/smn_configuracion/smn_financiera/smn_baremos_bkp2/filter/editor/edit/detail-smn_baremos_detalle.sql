select
	...
	(select smn_base.smn_v_auxiliar.aux_codigo || ' - ' || smn_base.smn_v_auxiliar.aux_descripcion from  smn_base.smn_v_auxiliar  where smn_base.smn_v_auxiliar.smn_v_auxiliar_id is not null  and smn_base.smn_v_auxiliar.smn_v_auxiliar_id=smn_base.smn_baremos_detalle.bad_auxiliar  order by smn_base.smn_v_auxiliar.aux_descripcion ) as bad_auxiliar2_name,
