document.form1.smn_grupos_prestadores_id_name.value='${fld:gpp_codigo_pl0@js}';
document.form1.smn_grupos_prestadores_id.value='${fld:smn_grupos_prestadores_id@#,###,###}';
document.form1.smn_servicios_id_name.value='${fld:svc_codigo_pl1@js}';
...
document.form1.cmp_tiempo_estimado.value='${fld:cmp_tiempo_estimado@#,###,##0.00}';
...
document.form1.cmp_precio.value='${fld:cmp_precio@#,###,##0.00}';
