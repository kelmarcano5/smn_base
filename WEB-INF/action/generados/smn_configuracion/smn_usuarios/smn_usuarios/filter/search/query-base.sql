select	
	...
	smn_base.smn_usuarios.usr_idioma,
	smn_base.smn_usuarios.usr_usuario,
	smn_base.smn_usuarios.usr_fecha_registro,
	smn_base.smn_usuarios.usr_hora,
	smn_base.smn_usuarios.smn_entidades_id,
	smn_base.smn_usuarios.usr_usuario_id,
	smn_base.smn_usuarios.usr_comunidad,
...
where
	smn_base.smn_usuarios.smn_usuarios_id is not null 
and 	
	smn_base.smn_entidades.smn_entidades_id=smn_base.smn_usuarios.smn_entidades_id 
	${filter}
order by 
	smn_base.smn_usuarios.smn_usuarios_id