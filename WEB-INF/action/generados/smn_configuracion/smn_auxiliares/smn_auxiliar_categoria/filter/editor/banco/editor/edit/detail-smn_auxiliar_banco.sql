select
	(select smn_base.smn_auxiliar_categoria.aca_codigo || ' - ' || smn_base.smn_auxiliar_categoria.aca_descripcion from  smn_base.smn_auxiliar_categoria  where smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id is not null  and smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id=smn_base.smn_auxiliar_banco.smn_auxiliar_categoria_id  order by smn_base.smn_auxiliar_categoria.aca_descripcion ) as smn_auxiliar_categoria_id2_name,
