select
	...
	(select smn_base.smn_auxiliar_cond_financiera.cfn_codigo || ' - ' || smn_base.smn_auxiliar_cond_financiera.cfn_descripcion from  smn_base.smn_auxiliar_cond_financiera  where smn_base.smn_auxiliar_cond_financiera.smn_condicion_financiera_id is not null  and smn_base.smn_auxiliar_cond_financiera.smn_condicion_financiera_id=smn_base.smn_auxiliar_medico.aam_condicion_financiera  order by smn_base.smn_auxiliar_cond_financiera.cfn_descripcion ) as aam_condicion_financiera2_name,
	case
	...
	smn_base.smn_auxiliar_medico.aam_nombre_corto as aam_nombre_corto2,
