...
where
	smn_auxiliar_tercero_id is not null	
and 	smn_base.smn_auxiliar_categoria.smn_auxiliar_categoria_id=smn_base.smn_auxiliar_tercero.smn_auxiliar_categoria_id 
	 	${filter}
order by 
