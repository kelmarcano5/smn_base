select	
	...
	smn_base.smn_terceros_modulos.smn_terceros_modulos_id

from
	smn_base.smn_terceros,
	smn_base.smn_terceros_modulos
where
	smn_terceros_modulos_id is not null	
and 	smn_base.smn_terceros.smn_terceros_id=smn_base.smn_terceros_modulos.smn_terceros_id 
	 	${filter}
order by 
