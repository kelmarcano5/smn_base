package domain.repgen.smn_configuracion.smn_ubicacion_geografica.smn_municipios;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("mun_ciudades_name");
			if (d != null)
			{
			name  = "b_city";
			label = "${lbl:b_city}";
		...
		d = rs.getString("mun_nombre_largo");
			if (d != null)
			{
			name  = "b_long_name";
