package domain.repgen.smn_configuracion.smn_sistema.smn_servicio_traduccion;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("set_app_id_name");
			if (d != null)
			{
			name  = "b_application";
			label = "${lbl:b_application}";
		...
		d = rs.getString("set_servicio_id_name");
			if (d != null)
			{
			name  = "b_service";
			label = "${lbl:b_service}";
		...
		d = rs.getString("set_servicio");
			if (d != null)
			{
			name  = "b_service_title";
			label = "${lbl:b_service_title}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("set_menu_id_name");
			if (d != null)
			{
			name  = "b_menu";
			label = "${lbl:b_menu}";
