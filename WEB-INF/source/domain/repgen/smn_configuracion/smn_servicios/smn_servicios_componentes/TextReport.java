package domain.repgen.smn_configuracion.smn_servicios.smn_servicios_componentes;
...
public class TextReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_services_components";
		String labelCustom = "${lbl:b_services_components}";
