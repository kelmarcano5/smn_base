package domain.repgen.smn_configuracion.smn_codificaciones.smn_atributo_valor;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("atv_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("atv_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("atv_fecha_registro_ini");
			if (d != null)
			{
