package domain.repgen.smn_configuracion.smn_codificaciones.smn_nivel_estructura;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("nes_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("nes_fecha_registro_ini");
			if (d != null)
			{
