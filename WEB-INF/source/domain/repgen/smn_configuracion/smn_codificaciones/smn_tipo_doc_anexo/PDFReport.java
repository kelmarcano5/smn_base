package domain.repgen.smn_configuracion.smn_codificaciones.smn_tipo_doc_anexo;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("tda_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("tda_descripción");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("tda_fecha_registro_ini");
			if (d != null)
			{
