...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ase_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
		...
		d = rs.getString("smn_tipos_areas_id_name");
			if (d != null)
			{
			name  = "b_types_area";
			label = "${lbl:b_types_area}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("ase_unidad_negocio");
			if (d != null)
			{
		...
		d = rs.getString("ase_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("ase_unidad_negocio_name");
			if (d != null)
			{
			name  = "b_business_unit";
			label = "${lbl:b_business_unit}";
		...
		d = rs.getString("ase_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("ase_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("ase_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("smn_tipos_areas_id");
			if (d != null)
			{
			name  = "b_types_area";
			label = "${lbl:b_types_area}";
