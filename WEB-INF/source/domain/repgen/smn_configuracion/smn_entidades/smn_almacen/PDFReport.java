...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("alm_unidad_negocio_name");
			if (d != null)
			{
		...
		d = rs.getString("alm_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
		...
		d = rs.getString("alm_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("alm_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
		...
		d = rs.getString("alm_unidad_negocio");
			if (d != null)
			{
			name  = "b_business_unit";
			label = "${lbl:b_business_unit}";
		...
		d = rs.getString("alm_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
