package domain.repgen.smn_configuracion.smn_entidades.smn_configuracion_estructura;
...
public class ExcelReportDetail extends AbstractExcelOutput
{
	...
	public WritableWorkbook createWorkbook(GenericTransaction data, ByteArrayOutputStream buf) throws Throwable
	{
		...
		String nameCustom  = "b_structure_configuration";
		String labelCustom = "${lbl:b_structure_configuration}";
