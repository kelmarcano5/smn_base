...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("cco_descripcion_larga");
			if (d != null)
			{
		...
		d = rs.getString("cco_almacen_name");
			if (d != null)
			{
			name  = "b_store";
			label = "${lbl:b_store}";
		...
		d = rs.getString("cco_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("cco_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("cco_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("cco_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
		...
		d = rs.getString("cco_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
			label = "${lbl:b_subsidiary}";
		...
		d = rs.getString("cco_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
