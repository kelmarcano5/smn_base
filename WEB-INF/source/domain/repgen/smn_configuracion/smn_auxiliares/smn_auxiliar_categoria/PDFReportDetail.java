...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("aca_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("aca_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("aca_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("aca_naturaleza_auxiliar");
			if (d != null)
			{
		...
		d = rs.getString("aca_sucursal_name");
			if (d != null)
			{
			name  = "b_subsidiary";
		...
		d = rs.getString("aca_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
		...
		d = rs.getString("aca_unidad_negocio_name");
			if (d != null)
			{
			name  = "b_business_unit";
			label = "${lbl:b_business_unit}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("aca_naturaleza_auxiliar_name");
			if (d != null)
			{
			name  = "b_nature_auxiliary";
			label = "${lbl:b_nature_auxiliary}";
		...
		d = rs.getString("aca_unidad_negocio");
			if (d != null)
			{
			name  = "b_business_unit";
			label = "${lbl:b_business_unit}";
		...
		d = rs.getString("aca_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
