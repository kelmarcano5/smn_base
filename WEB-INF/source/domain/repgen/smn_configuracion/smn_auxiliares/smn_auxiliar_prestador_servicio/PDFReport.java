package domain.repgen.smn_configuracion.smn_auxiliares.smn_auxiliar_prestador_servicio;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("aux_descripcion");
			if (d != null)
			{
			name  = "b_description";
