...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("acb_tipo_cta_banco");
			if (d != null)
			{
			name  = "b_account_bank_type";
			label = "${lbl:b_account_bank_type}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("acb_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("acb_banco_pertenece_name");
			if (d != null)
			{
			name  = "b_bank";
			label = "${lbl:b_bank}";
		...
		d = rs.getString("acb_banco_pertenece");
			if (d != null)
			{
			name  = "b_bank";
			label = "${lbl:b_bank}";
		...
		d = rs.getString("acb_num_cuenta");
			if (d != null)
			{
			name  = "b_account_number";
			label = "${lbl:b_account_number}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("acb_tipo_cta_banco_name");
			if (d != null)
			{
			name  = "b_account_bank_type";
			label = "${lbl:b_account_bank_type}";
		...
		d = rs.getString("acb_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
