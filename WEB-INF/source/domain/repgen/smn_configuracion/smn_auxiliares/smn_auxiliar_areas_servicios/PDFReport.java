...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("tse_auxiliar_sucursal");
			if (d != null)
			{
			name  = "b_outsourced_subsidiary";
			label = "${lbl:b_outsourced_subsidiary}";
		...
		d = rs.getString("tse_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary";
		...
		d = rs.getString("smn_auxiliar_tipos_servicios_id_name");
			if (d != null)
			{
			name  = "b_outsourced_type_of_service";
			label = "${lbl:b_outsourced_type_of_service}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("tse_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("tse_auxiliar_unidad_negocio_name");
			if (d != null)
			{
			name  = "b_outsourced_unit_business";
			label = "${lbl:b_outsourced_unit_business}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("tse_auxiliar_unidad_negocio");
			if (d != null)
			{
			name  = "b_outsourced_unit_business";
			label = "${lbl:b_outsourced_unit_business}";
		...
		d = rs.getString("tse_auxiliar_sucursal_name");
			if (d != null)
			{
			name  = "b_outsourced_subsidiary";
			label = "${lbl:b_outsourced_subsidiary}";
		...
		d = rs.getString("smn_auxiliar_tipos_servicios_id");
			if (d != null)
			{
			name  = "b_outsourced_type_of_service";
			label = "${lbl:b_outsourced_type_of_service}";
