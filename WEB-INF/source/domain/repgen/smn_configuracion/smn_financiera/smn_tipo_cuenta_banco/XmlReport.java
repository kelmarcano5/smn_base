package domain.repgen.smn_configuracion.smn_financiera.smn_tipo_cuenta_banco;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_types_of_bank_accounts";
		String labelCustom = "${lbl:b_types_of_bank_accounts}";
