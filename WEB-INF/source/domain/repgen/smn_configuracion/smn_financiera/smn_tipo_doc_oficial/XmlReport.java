package domain.repgen.smn_configuracion.smn_financiera.smn_tipo_doc_oficial;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_official_document_type";
		String labelCustom = "${lbl:b_official_document_type}";
