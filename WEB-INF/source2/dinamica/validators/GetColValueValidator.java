...
public class GetColValueValidator extends AbstractValidator {
	...
	public boolean isValid(HttpServletRequest req, Recordset inputParams,
		...
		if(rs.getRecordCount()==0)
			...
			//java.io.FileWriter fw = new java.io.FileWriter("C:/tomcat7/logs/simone.log",true);
			//fw.write("SQL = " + sql + "\n");
			rs.first();
			Object value = rs.getValue(setValue);
			/*if (value instanceof String) {
				fw.write("Value = " + (String)value + "\n");
				fw.write("Type = String" + "\n");
			} else if (value instanceof Integer) {
				fw.write("Value = " + (Integer)value + "\n");
				fw.write("Type = Integer" + "\n");
			}
			fw.write("=================================================");
			fw.close();
			*/
