...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ent_corporacion");
			if (d != null)
			{
			name  = "b_corporation";
		...
		d = rs.getString("ent_unidad_negocio_name");
			if (d != null)
			{
		...
		d = rs.getString("ent_comunidad");
			if (d != null)
			{
			name  = "b_community";
			label = "${lbl:b_community}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("ent_corporacion_name");
			if (d != null)
			{
			name  = "b_corporation";
			label = "${lbl:b_corporation}";
		...
		d = rs.getString("ent_nro_id_fiscal");
			if (d != null)
			{
		...
		d = rs.getString("ent_unidad_negocio");
			if (d != null)
			{
			name  = "b_business_unit";
			label = "${lbl:b_business_unit}";
		...
		d = rs.getString("ent_descripcion_larga");
			if (d != null)
			{
			name  = "b_long_description";
			label = "${lbl:b_long_description}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("ent_comunidad_name");
			if (d != null)
			{
			name  = "b_community";
			label = "${lbl:b_community}";
