...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("pai_codigo_ddi");
			if (d != null)
			{
			name  = "b_international_dailing_code";
			label = "${lbl:b_international_dailing_code}";
		...
		d = rs.getString("pai_moneda_oficial_name");
			if (d != null)
			{
			name  = "b_official_coin";
			label = "${lbl:b_official_coin}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("pai_nombre_largo");
			if (d != null)
			{
			name  = "b_long_name";
			label = "${lbl:b_long_name}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
