...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("dir_parroquia_name");
			if (d != null)
			{
			name  = "b_choose";
			label = "${lbl:b_choose}";
		...
		d = rs.getString("dir_ciudad_name");
			if (d != null)
			{
			name  = "b_choose";
			label = "${lbl:b_choose}";
		...
		d = rs.getString("dir_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("dir_entidad_federal");
			if (d != null)
			{
		...
		d = rs.getString("dir_municipio_name");
			if (d != null)
			{
			name  = "b_choose";
			label = "${lbl:b_choose}";
		...
		d = rs.getString("dir_zona_postal_name");
			if (d != null)
			{
			name  = "b_choose";
			label = "${lbl:b_choose}";
		...
		d = rs.getString("dir_entidad_federal_name");
			if (d != null)
			{
			name  = "b_choose";
			label = "${lbl:b_choose}";
		...
		d = rs.getString("dir_zona_postal");
			if (d != null)
			{
			name  = "b_postal_zone";
			label = "${lbl:b_postal_zone}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
