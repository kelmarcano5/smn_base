package domain.repgen.smn_configuracion.smn_ubicacion_geografica.smn_zonas_postales;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("zpo_parroquias_name");
			if (d != null)
			{
			name  = "b_parish";
			label = "${lbl:b_parish}";
