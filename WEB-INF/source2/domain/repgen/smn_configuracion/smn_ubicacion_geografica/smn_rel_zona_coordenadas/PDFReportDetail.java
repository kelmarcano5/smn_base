package domain.repgen.smn_configuracion.smn_rel_zona_coordenadas;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("smn_ciudad_rf_name");
			if (d != null)
			{
			name  = "b_city";
			label = "${lbl:b_city}";
		...
		d = rs.getString("smn_parroquia_rf");
			if (d != null)
			{
			name  = "b_parish";
			label = "${lbl:b_parish}";
		...
		d = rs.getString("smn_zona_id_name");
			if (d != null)
			{
			name  = "b_zone";
			label = "${lbl:b_zone}";
		...
		d = rs.getString("smn_municipio_rf");
			if (d != null)
			{
			name  = "b_municipality";
			label = "${lbl:b_municipality}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("rzc_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("smn_entidad_federal_rf");
			if (d != null)
			{
			name  = "b_federal_entity";
			label = "${lbl:b_federal_entity}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("rzc_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("smn_parroquia_rf_name");
			if (d != null)
			{
			name  = "b_parish";
			label = "${lbl:b_parish}";
		...
		d = rs.getString("smn_municipio_rf_name");
			if (d != null)
			{
			name  = "b_municipality";
			label = "${lbl:b_municipality}";
		...
		d = rs.getString("smn_pais_rf_name");
			if (d != null)
			{
			name  = "b_country";
			label = "${lbl:b_country}";
		...
		d = rs.getString("smn_entidad_federal_rf_name");
			if (d != null)
			{
			name  = "b_federal_entity";
			label = "${lbl:b_federal_entity}";
