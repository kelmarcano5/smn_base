package domain.repgen.smn_configuracion.smn_codificaciones.smn_atributo_item;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ati_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("ati_fecha_registro_ini");
			if (d != null)
			{
