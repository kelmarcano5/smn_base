package domain.repgen.smn_configuracion.smn_rel_cues_secc_preg;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_smn_rel_cues_secc_preg";
		String labelCustom = "${lbl:b_smn_rel_cues_secc_preg}";
