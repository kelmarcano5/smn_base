package domain.repgen.smn_procesos.smn_respuesta;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_tipo_respuesta_id");
			if (d != null)
			{
			name  = "b_smn_tipo_respuesta_id";
			label = "${lbl:b_smn_tipo_respuesta_id}";
		...
		d = rs.getString("smn_tipo_respuesta_id_name");
			if (d != null)
			{
			name  = "b_smn_tipo_respuesta_id";
			label = "${lbl:b_smn_tipo_respuesta_id}";
		...
		d = rs.getString("smn_variable_id");
			if (d != null)
			{
			name  = "b_smn_variable";
			label = "${lbl:b_smn_variable}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("res_texto_respuesta");
			if (d != null)
			{
			name  = "b_res_texto_respuesta";
			label = "${lbl:b_res_texto_respuesta}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
