package domain.repgen.smn_configuracion.smn_rel_cuestionario_seccion;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_smn_rel_cuestionario_seccion";
		String labelCustom = "${lbl:b_smn_rel_cuestionario_seccion}";
