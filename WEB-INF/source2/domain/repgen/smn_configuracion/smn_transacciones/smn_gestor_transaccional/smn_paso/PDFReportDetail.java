package domain.repgen.smn_configuracion.smn_transacciones.smn_gestor_transaccional.smn_paso;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("pas_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("pas_fecha_registro");
			if (d != null)
			{
