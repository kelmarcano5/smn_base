package domain.repgen.smn_configuracion.smn_transacciones.smn_gestor_transaccional.smn_accion;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("acc_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("acc_fecha_registro");
			if (d != null)
			{
