package domain.repgen.smn_configuracion.smn_financiera.smn_rel_serv_tipo_doc_anexo;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_servicios_id");
			if (d != null)
			{
			name  = "b_service";
			label = "${lbl:b_service}";
		...
		d = rs.getString("smn_servicios_id_name");
			if (d != null)
			{
			name  = "b_service";
			label = "${lbl:b_service}";
		...
		d = rs.getString("rst_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("smn_tipo_doc_anexo_id");
			if (d != null)
			{
			name  = "b_tipo_documento_anexo";
			label = "${lbl:b_tipo_documento_anexo}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("rst_fecha_registro_ini");
			if (d != null)
			{
		...
		d = rs.getString("smn_tipo_doc_anexo_id_name");
			if (d != null)
			{
			name  = "b_tipo_documento_anexo";
			label = "${lbl:b_tipo_documento_anexo}";
