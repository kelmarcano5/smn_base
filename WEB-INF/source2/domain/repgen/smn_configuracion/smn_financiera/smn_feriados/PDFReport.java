...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("fer_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("fer_laborable");
			if (d != null)
			{
			name  = "b_workable";
			label = "${lbl:b_workable}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("fer_municipio_name");
			if (d != null)
			{
			name  = "b_municipality";
		...
		d = rs.getString("fer_entidad_federal_name");
			if (d != null)
			{
			name  = "b_federal_entities";
			label = "${lbl:b_federal_entities}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("fer_entidad_federal");
			if (d != null)
			{
			name  = "b_federal_entities";
			label = "${lbl:b_federal_entities}";
		...
		d = rs.getString("fer_ciudad_name");
			if (d != null)
			{
			name  = "b_city";
			label = "${lbl:b_city}";
