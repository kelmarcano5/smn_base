package domain.repgen.smn_configuracion.smn_financiera.smn_sectores_economicos;
...
public class ExcelReportDetail extends AbstractExcelOutput
{
	...
	public WritableWorkbook createWorkbook(GenericTransaction data, ByteArrayOutputStream buf) throws Throwable
	{
		...
		String nameCustom  = "b_economic_sectors";
		String labelCustom = "${lbl:b_economic_sectors}";
