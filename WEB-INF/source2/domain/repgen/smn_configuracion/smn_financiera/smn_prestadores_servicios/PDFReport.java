...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("prs_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary";
			label = "${lbl:b_auxiliary}";
		...
		d = rs.getString("prs_unidad_servicio_name");
			if (d != null)
			{
			name  = "b_service_unit";
		...
		d = rs.getString("prs_area_servicio_name");
			if (d != null)
			{
			name  = "b_service_area";
		...
		d = rs.getString("prs_area_servicio");
			if (d != null)
			{
			name  = "b_service_area";
			label = "${lbl:b_service_area}";
		...
		d = rs.getString("prs_unidad_servicio");
			if (d != null)
			{
			name  = "b_service_unit";
			label = "${lbl:b_service_unit}";
