package domain.repgen.smn_configuracion.smn_auxiliares.smn_auxiliar_tipos_servicios;
...
public class XmlReport extends GenericOutput
{
	...
	public void print(TemplateEngine te, GenericTransaction data) throws Throwable
	{
		...
		String nameCustom  = "b_outsourced_types_of_services";
		String labelCustom = "${lbl:b_outsourced_types_of_services}";
