...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("tco_responsable");
			if (d != null)
			{
			name  = "b_responsible";
		...
		d = rs.getString("tco_clase_auxiliar");
			if (d != null)
			{
		...
		d = rs.getString("tco_clase_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary_class";
			label = "${lbl:b_auxiliary_class}";
		...
		d = rs.getString("tco_descripcion_larga");
			if (d != null)
			{
		...
		d = rs.getString("tco_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary";
			label = "${lbl:b_auxiliary}";
