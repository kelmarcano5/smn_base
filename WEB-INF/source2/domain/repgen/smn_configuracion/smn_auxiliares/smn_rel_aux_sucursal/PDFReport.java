package domain.repgen.smn_configuracion.smn_auxiliares.smn_rel_aux_sucursal;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("smn_auxiliar_sucursal_id");
			if (d != null)
			{
		...
		d = rs.getString("smn_auxiliar_sucursal_id_name");
			if (d != null)
			{
			name  = "b_outsourced_subsidiary";
			label = "${lbl:b_outsourced_subsidiary}";
