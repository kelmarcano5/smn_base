package domain.repgen.smn_configuracion.smn_auxiliares.smn_auxiliar_persona_natural;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("aux_tipo_doc_oficial");
			if (d != null)
			{
			name  = "b_document_type_oficial";
			label = "${lbl:b_document_type_oficial}";
		...
		d = rs.getString("aux_apellidos");
			if (d != null)
			{
			name  = "b_last_name";
			label = "${lbl:b_last_name}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_clase_auxiliar_name");
			if (d != null)
			{
			name  = "b_class_auxiliary";
			label = "${lbl:b_class_auxiliary}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_naturaleza_auxiliar_id_name");
			if (d != null)
			{
			name  = "b_nature_auxiliary";
			label = "${lbl:b_nature_auxiliary}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_naturaleza_auxiliar_id");
			if (d != null)
			{
			name  = "b_nature_auxiliary";
			label = "${lbl:b_nature_auxiliary}";
		...
		d = rs.getString("aux_tipo_persona");
			if (d != null)
			{
			name  = "b_person_type";
			label = "${lbl:b_person_type}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("aux_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("smn_clase_auxiliar");
			if (d != null)
			{
			name  = "b_class_auxiliary";
			label = "${lbl:b_class_auxiliary}";
		...
		d = rs.getString("aux_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("aux_nombres");
			if (d != null)
			{
			name  = "b_first_name";
			label = "${lbl:b_first_name}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
