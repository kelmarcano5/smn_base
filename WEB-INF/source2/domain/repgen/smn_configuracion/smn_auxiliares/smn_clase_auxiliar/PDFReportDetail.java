...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("cla_naturaleza_name");
			if (d != null)
			{
			name  = "b_nature";
			label = "${lbl:b_nature}";
		...
		d = rs.getString("cla_modulo_name");
			if (d != null)
			{
			name  = "b_module";
			label = "${lbl:b_module}";
