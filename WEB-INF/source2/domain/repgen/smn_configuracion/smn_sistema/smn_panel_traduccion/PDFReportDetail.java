package domain.repgen.smn_configuracion.smn_sistema.smn_panel_traduccion;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("pat_description");
			if (d != null)
			{
			name  = "b_description";
