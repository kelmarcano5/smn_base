package domain.repgen.smn_configuracion.smn_sistema.smn_modulos;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("mod_empresa_name");
			if (d != null)
			{
			name  = "b_entity";
			label = "${lbl:b_entity}";
		...
		d = rs.getString("mod_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("mod_fecha_registro_ini");
			if (d != null)
			{
